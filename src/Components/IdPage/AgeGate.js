...
export default function AgeGate ({isLegalAge,day, month, year, country,countries}){
        ...
        else{return ageCheck >= countryDrinkAge  ? isLegalAge(true):isLegalAge(false)}//sends true or false to App.js
      }
